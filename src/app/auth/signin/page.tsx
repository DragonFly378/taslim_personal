    ...
    <div className="min-h-[80vh] flex items-center justify-center">
      <Card className="w-full max-w-md card-glow border-2">
        ...
        <CardHeader className="text-center pb-4">
          ...
          <CardTitle className="text-2xl">Sign in to Taslim</CardTitle>
          <CardDescription className="text-base">
            Access your bookmarks and reading progress across devices
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {emailSent ? (
            <div className="text-center p-6 bg-gradient-to-br from-primary/10 to-secondary/10 rounded-xl border border-primary/20">
              ...
              <h3 className="text-lg font-semibold mb-2 text-foreground">Check your email</h3>
              <p className="text-sm text-muted-foreground">
                We sent you a sign-in link to <strong>{email}</strong>
              </p>
            </div>
          ) : (
            <>
          ...
          <div className="text-center text-sm text-muted-foreground pt-4">
            <p>
              By signing in, you can sync your bookmarks and reading progress across all your devices.
            </p>
            <p className="mt-2">
              Guest mode is still available without signing in!
            </p>
          </div>
        </CardContent>
      </Card>
